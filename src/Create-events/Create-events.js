import { Box, Button, Text, Layer, Select, Grommet } from "grommet";
        ...
        {show && (
          ...
          >
            ...
            >
              ...
              >
                <EventTitle onChange={setTitle} value={title} />
              </Box>
              <Box
                margin={{
                  top: "xsmall",
              ...
              >
                ...
                <AddDate onChange={setDate} value={date} />
              </Box>
              <Box
                margin={{
                  top: "small",
                ...
                onClick={() => {
                  setNewEvents(
                    props.events,
                    {
                      id: "3",
                      title: title,
                      start: `${date.split("T")[0]}T${parseEventTime(
                        timeStart
                      )}`,
